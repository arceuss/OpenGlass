...
| CaptionTextAliasing | DWORD | Selects which OS' ClearType aliasing the title bar text is rendered with.<br><br><ul><li>0x0 = Windows 7 style (default)</li><li>0x1 = Windows 8 style (heavier stems, stronger colour fringing)</li></ul> |
